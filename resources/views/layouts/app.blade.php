...
<body>
    <div id="app">
        <div class="headers-wrapp">
                ...
                <div class="container">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items:center; height: 44px;">
                        <div class="pre-header-email-page">
                            ...
                            <a class="{{ request()->is('*/account*') ? 'active' : '' }}"
                                href="{{ route('account.index') }}">Push</a>
                        </div>
                    ...
                    <div class="header__inner">
                        ...
                        @auth
                            <div class="header__subscription">
                                ...
                                <a href="{{ route('tariff.index') }}" class="header__subscription_link">@lang('Повысить
                                    тариф')</a>
                            </div>
                                ...
                                <div class="notification__amount__left">
                                    @foreach ($system_messages as $message)
                                        <span class="notification__item active">
                                            <p>{{ $message->created_at->format('d.m.Y') }}<a
                                                    style="font-size: 12px; margin-left: 15px;">Смотреть полностью</a></p>
                                            <p>{{ $message->title }}</p>
                        ...
                        <div class="header__popup_inner">
                            ...
                            @auth
                                ...
                                <div class="nav__menu_item" v-if="$store.state.sites.sites.length < 1">
                                    <a class="nav__menu_link" href="{{ route('site.create') }}">@lang('Добавить
                                        сайт')</a>
                                </div>
                                <div class="nav__menu_item" v-if="$store.state.sites.sites.length < 1">
                                    <a class="nav__menu_link" href="{{ route('site.create') }}">@lang('Добавить
                            ...
                            @auth
                                <div class="header__subscription header__mobile_sub">
                                    <h3 class="header__subscription_title">@lang('Тариф') "@lang(Auth::user()->tariff->name)
                                        "</h3>
                                    <a href="{{ route('tariff.index') }}"
                                        class="header__subscription_link">@lang('Повысить
                                        тариф')</a>
                                </div>
                            @endauth
                        </div>
            ...
            <header class="header {{ request()->is('*/account*') ? 'active' : '' }}">
                <div class="container">
                    <div class="header__inner">
                        <a href="{{ route('account.index') }}" class="header__logo">
                            <img style="width: 208px;height: 16px;" src="{{ asset('images/logo.png') }}" alt=""
