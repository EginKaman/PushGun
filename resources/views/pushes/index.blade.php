            ...
            <div style="margin-bottom: 15px;" class="create-mail">
                ...
                <div class="button_green mr-24">
                    ...
                    <a href="{{ route('account.createmailingrss') }}" class="button_green_inner">
                        <img src="{{ asset('images/plusik.svg') }}" alt="">
                        <p class="button_text_container"><img src="" alt="">Создать RSS рассылку</p>
                    </a>
                </div>
            </div>
                ...
                <div class="general__sites_item mails__sites">
                    <div class="flex">
                        <a href="{{ route('push.show', $push) }}">
                            @if(!empty($push->icon))
                            <img class="general__sites_item-img" src="{{ asset(Storage::url($push->icon)) }}">
                            @elseif(!empty($push->site->image))
                            <img class="general__sites_item-img" src="{{ asset(Storage::url($push->site->image)) }}">
                            @else
