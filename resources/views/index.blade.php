        ...
        <div class="container">
            <div class="header-landing__wrapper">
                ...
                <ul class="header-landing__wrapper__menu">
                    ...
                    <li><a href="{{ route('blog.index') }}">@lang('Блог')</a></li>
                </ul>
                ...
                <div class="hamburger-menu">
                    ...
                    <ul class="menu__box">
                        ...
                        <li><a class="menu__item" href="{{ route('blog.index') }}">@lang('Блог')</a></li>
                        <li>
        ...
        <div class="container">
            ...
            <a href="#aboutus" class="btn_dwn"> <span class="whiteBg"></span>
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M34.5 33.5L30 38M30 38L25.5 33.5M30 38V22" stroke="#323441" stroke-width="1.5"
                ...
                <div class="section2__itemsWrapper__item">
                    <svg width="85" height="71" viewBox="0 0 85 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint1_linear" x1="-9.22226e-07" y1="16.375" x2="32.5833" y2="48.9584"
                                            gradientUnits="userSpaceOnUse">
                ...
                <div class="section2__itemsWrapper__item">
                    <svg width="85" height="69" viewBox="0 0 85 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#F0F7FF"/>
                        <defs>
                            <linearGradient id="paint0_linear" x1="-0.517492" y1="0.754747" x2="53.7002" y2="76.0279"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#D6E9F5"/>
                                <stop offset="1" stop-color="#ADD2EB"/>
                            </linearGradient>
                ...
                <div class="section2__itemsWrapper__item">
                    <svg width="85" height="75" viewBox="0 0 85 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#EAF4FB"/>
                        <defs>
                            <linearGradient id="paint0_linear" x1="-0.604662" y1="0.246189" x2="60.8865" y2="87.5558"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#D6E9F5"/>
                                <stop offset="1" stop-color="#ADD2EB"/>
                            </linearGradient>
                ...
                <div class="section2__itemsWrapper__item">
                    <svg width="73" height="85" viewBox="0 0 73 85" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="white"/>
                        <defs>
                            <linearGradient id="paint0_linear" x1="-0.243021" y1="-0.0885062" x2="71.1676" y2="52.7836"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#D6E9F5"/>
                                <stop offset="1" stop-color="#ADD2EB"/>
                            </linearGradient>
        ...
        <div class="container">
            ...
            <div class="section-blog-block__wrapper">
                <div class="section-blog__item">
                    <img src="{{ asset('images/plane.svg') }}" alt="{{ $blogs->first()->title }}">
                    ...
                    <div class="section-blog-content__wrapper">
                        @foreach($blogs as $blog)
                            <div class="section-blog__content">
                                <img src="{{ asset('images/plane.svg') }}" alt="{{ $blog->title }}">
