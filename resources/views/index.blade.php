                ...
                <div class="business-wrap">
                    ...
                    <div data-content="1" class="business-content active">
                            ...
                            <div class="business-content__wrap">
                                ...
                                <p>Пользователь смотрел товар в разделе «брюки» - не положил товар в корзину - 20% на все брюки только 2 дня</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                    ...
                    <div data-content="2" class="business-content">
                            <div class="business-content__wrap">
                                ...
                                <p>Пользователь бросил заполнение анкеты на кредитную карту, через несколько минут отправляем предложение дополнить поля анкеты для получения карты</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                            ...
                            <div class="business-content__wrap">
                                <h4>Брошенный просмотр категории</h4>
                                <p>Пользователь смотрел или сравнивал продукты, но не начал заполнение анкеты, предложите ему уникальный продукт</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                    ...
                    <div data-content="3" class="business-content">
                            <div class="business-content__wrap">
                                <h4>Брошенная корзина</h4>
                                <p>Пользователь положил товары в корзину и ушел, не закончив покупку, верните его за счет спецпредложения с помощью сервиса рассылки push уведомлений</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                            ...
                            <div class="business-content__wrap">
                                <h4>Специальные предложения</h4>
                                <p>Создавайте поводы, что бы пользователи приходили к вам с помощью сервиса рассылки пуш уведомлений</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                    ...
                    <div data-content="4" class="business-content">
                            <div class="business-content__wrap">
                                ...
                                <p>Отправка подписчикам новостей на основе алгоритма интересов от бесплатного сервиса push уведомлений</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
                        ...
                        <div data-content="5" class="business-content">
                            <div class="business-content__wrap">
                                <h4>Брошенная заявка</h4>
                                <p>Пользователь бросил заполнение анкеты на просмотр, через несколько минут отправляем предложение дополнить поля анкеты для записи на просмотр</p>
                                <div class="business-window">
                                    <div class="business-window__inner">
