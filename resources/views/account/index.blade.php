...
<main class="main">
    <div class="container">
    @if(session('verified', false)) <div class="auth-confirm">
    ...
    <section class="general">
        <div class="general__title">
            ...
            <img class="general__info tooltip" data-tooltip-content="#tooltip_content" src="{{ asset('images/info.svg') }}" alt="">
        </div>
        <div class="general__status">
            ...
            <div class="progress">
                <progress max="100" value="{{ round(($sites->sum('push_subscriptions_count')/ $user->tariff->max_followers)*100, 2) }}"></progress>
