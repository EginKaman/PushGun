<template>
    <div class="set-war" v-if="!isPushEnabled">
        {{ $t('Похоже вы запретили получение уведомлений от PushGun. Разблокируйте для получения уведомлений') }}
    </div>
</template>
    ...
    methods: {
        ...
        subscribe() {
            navigator.serviceWorker.ready.then(registration => {
                ...
                const vapidPublicKey = this.public_key
