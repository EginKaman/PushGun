<template>
  <div>
    ...
    >
      ...
      >
        <li v-if="resetOption.isShow" @click="reset" class="v-select_li__hover">
 ...
 props: {
  ...
  methods: {
      ...
      selectInModeMultiple(item) {
        ...
        if(isSelected) {
          this.selected.splice(this.selected.indexOf(item[this.keyName]),1)
          this.selectText.splice(this.selectText.indexOf(item[this.optionName],1))
          return
        }
