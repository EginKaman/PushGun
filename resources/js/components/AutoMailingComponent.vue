    ...
    <div :class="{ noActive: showMenus === true }" class="button_green mr-24">
      ...
      <a @click="showMenus = true" class="button_green_inner">
        <p class="button_text_container">
          <img src="../../images/send.svg" alt="" />Создать автоматическую
          рассылку
        </p>
      </a>
    </div>
    <div v-if="showMenus === true" class="btn-menus">
      <a href="/account/saveMailing" class="btn-menus__item">
        ...
        <div class="txt-block">
          <p>Серия сообщений</p>
          <span
            >Отправка серии сообщений после подписки на push уведомления</span
          >
        </div>
      </a>
      <a @click="rssShow = true" class="btn-menus__item rss">
        ...
        <div class="txt-block">
          ...
          <span
            >Отправка push сообщеий после добавлеия новых записей в RSS
            ленте</span
          >
        </div>
      </a>
        ...
        <div v-click-outside="rssClose" class="rss__wrapper__block">
          ...
          <div class="rss__wrapper__block__content">
            ...
            <label>
              ...
              <input type="text" placeholder="https://example.com/rss" />
            </label>
            <div class="rss__wrapper__block__btn">
              <div class="button_green mr-24">
                <span class="green_button_circle"></span>
                <a href="/account/saveMailingRss" class="button_green_inner">
                  <p class="button_text_container">Проверить URL</p>
                </a>
              </div>
